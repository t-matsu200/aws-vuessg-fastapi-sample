...
aws cloudformation deploy \
  ...
  --parameter-overrides \
    ...
    CodeDeployDeploymentGroup="$CODE_DEPLOY_GROUP_NAME"     PipelineArtifactBucketParameterName="$SSM_PARAM_NAME_FOR_PIPELINE_ARTIFACT_BUCKET"   --capabilities CAPABILITY_IAM   --no-fail-on-empty-changeset
