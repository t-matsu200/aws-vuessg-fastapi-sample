...
required_vars=("AWS_REGION" "STACK_NAME" "CODE_DEPLOY_APP_NAME" "CODE_DEPLOY_GROUP_NAME" "GITHUB_OWNER" "GITHUB_REPO" "GITHUB_BRANCH" "SSM_PARAM_NAME_FOR_CONNECTION_ARN")
